[@the-shops/auth](../globals.md) › ["models/contact.model"](../modules/_models_contact_model_.md) › [Contact](_models_contact_model_.contact.md)
...
* [constructor](_models_contact_model_.contact.md#constructor)

### Properties

* [isNewRecord](_models_contact_model_.contact.md#isnewrecord)
* [sequelize](_models_contact_model_.contact.md#sequelize)
* [associations](_models_contact_model_.contact.md#static-associations)
* [options](_models_contact_model_.contact.md#static-options)
* [primaryKeyAttribute](_models_contact_model_.contact.md#static-primarykeyattribute)
* [primaryKeyAttributes](_models_contact_model_.contact.md#static-primarykeyattributes)
* [rawAttributes](_models_contact_model_.contact.md#static-rawattributes)
* [sequelize](_models_contact_model_.contact.md#static-optional-sequelize)
* [tableName](_models_contact_model_.contact.md#static-tablename)

### Methods

* [addHook](_models_contact_model_.contact.md#addhook)
* [changed](_models_contact_model_.contact.md#changed)
* [decrement](_models_contact_model_.contact.md#decrement)
* [destroy](_models_contact_model_.contact.md#destroy)
* [equals](_models_contact_model_.contact.md#equals)
* [equalsOneOf](_models_contact_model_.contact.md#equalsoneof)
* [get](_models_contact_model_.contact.md#get)
* [getDataValue](_models_contact_model_.contact.md#getdatavalue)
* [hasHook](_models_contact_model_.contact.md#hashook)
* [hasHooks](_models_contact_model_.contact.md#hashooks)
* [increment](_models_contact_model_.contact.md#increment)
* [previous](_models_contact_model_.contact.md#previous)
* [reload](_models_contact_model_.contact.md#reload)
* [removeHook](_models_contact_model_.contact.md#removehook)
* [restore](_models_contact_model_.contact.md#restore)
* [save](_models_contact_model_.contact.md#save)
* [set](_models_contact_model_.contact.md#set)
* [setAttributes](_models_contact_model_.contact.md#setattributes)
* [setDataValue](_models_contact_model_.contact.md#setdatavalue)
* [toJSON](_models_contact_model_.contact.md#tojson)
* [update](_models_contact_model_.contact.md#update)
* [validate](_models_contact_model_.contact.md#validate)
* [where](_models_contact_model_.contact.md#where)
* [addHook](_models_contact_model_.contact.md#static-addhook)
* [addScope](_models_contact_model_.contact.md#static-addscope)
* [afterBulkCreate](_models_contact_model_.contact.md#static-afterbulkcreate)
* [afterBulkDestroy](_models_contact_model_.contact.md#static-afterbulkdestroy)
* [afterBulkSync](_models_contact_model_.contact.md#static-afterbulksync)
* [afterBulkUpdate](_models_contact_model_.contact.md#static-afterbulkupdate)
* [afterCreate](_models_contact_model_.contact.md#static-aftercreate)
* [afterDestroy](_models_contact_model_.contact.md#static-afterdestroy)
* [afterFind](_models_contact_model_.contact.md#static-afterfind)
* [afterSave](_models_contact_model_.contact.md#static-aftersave)
* [afterSync](_models_contact_model_.contact.md#static-aftersync)
* [afterUpdate](_models_contact_model_.contact.md#static-afterupdate)
* [afterValidate](_models_contact_model_.contact.md#static-aftervalidate)
* [aggregate](_models_contact_model_.contact.md#static-aggregate)
* [beforeBulkCreate](_models_contact_model_.contact.md#static-beforebulkcreate)
* [beforeBulkDestroy](_models_contact_model_.contact.md#static-beforebulkdestroy)
* [beforeBulkSync](_models_contact_model_.contact.md#static-beforebulksync)
* [beforeBulkUpdate](_models_contact_model_.contact.md#static-beforebulkupdate)
* [beforeCount](_models_contact_model_.contact.md#static-beforecount)
* [beforeCreate](_models_contact_model_.contact.md#static-beforecreate)
* [beforeDestroy](_models_contact_model_.contact.md#static-beforedestroy)
* [beforeFind](_models_contact_model_.contact.md#static-beforefind)
* [beforeFindAfterExpandIncludeAll](_models_contact_model_.contact.md#static-beforefindafterexpandincludeall)
* [beforeFindAfterOptions](_models_contact_model_.contact.md#static-beforefindafteroptions)
* [beforeSave](_models_contact_model_.contact.md#static-beforesave)
* [beforeSync](_models_contact_model_.contact.md#static-beforesync)
* [beforeUpdate](_models_contact_model_.contact.md#static-beforeupdate)
* [beforeValidate](_models_contact_model_.contact.md#static-beforevalidate)
* [belongsTo](_models_contact_model_.contact.md#static-belongsto)
* [belongsToMany](_models_contact_model_.contact.md#static-belongstomany)
* [build](_models_contact_model_.contact.md#static-build)
* [bulkBuild](_models_contact_model_.contact.md#static-bulkbuild)
* [bulkCreate](_models_contact_model_.contact.md#static-bulkcreate)
* [count](_models_contact_model_.contact.md#static-count)
* [create](_models_contact_model_.contact.md#static-create)
* [describe](_models_contact_model_.contact.md#static-describe)
* [destroy](_models_contact_model_.contact.md#static-destroy)
* [drop](_models_contact_model_.contact.md#static-drop)
* [findAll](_models_contact_model_.contact.md#static-findall)
* [findAndCountAll](_models_contact_model_.contact.md#static-findandcountall)
* [findByPk](_models_contact_model_.contact.md#static-findbypk)
* [findCreateFind](_models_contact_model_.contact.md#static-findcreatefind)
* [findOne](_models_contact_model_.contact.md#static-findone)
* [findOrBuild](_models_contact_model_.contact.md#static-findorbuild)
* [findOrCreate](_models_contact_model_.contact.md#static-findorcreate)
* [getTableName](_models_contact_model_.contact.md#static-gettablename)
* [hasHook](_models_contact_model_.contact.md#static-hashook)
* [hasHooks](_models_contact_model_.contact.md#static-hashooks)
* [hasMany](_models_contact_model_.contact.md#static-hasmany)
* [hasOne](_models_contact_model_.contact.md#static-hasone)
* [increment](_models_contact_model_.contact.md#static-increment)
* [init](_models_contact_model_.contact.md#static-init)
* [max](_models_contact_model_.contact.md#static-max)
* [min](_models_contact_model_.contact.md#static-min)
* [removeAttribute](_models_contact_model_.contact.md#static-removeattribute)
* [removeHook](_models_contact_model_.contact.md#static-removehook)
* [restore](_models_contact_model_.contact.md#static-restore)
* [schema](_models_contact_model_.contact.md#static-schema)
* [scope](_models_contact_model_.contact.md#static-scope)
* [sum](_models_contact_model_.contact.md#static-sum)
* [sync](_models_contact_model_.contact.md#static-sync)
* [truncate](_models_contact_model_.contact.md#static-truncate)
* [unscoped](_models_contact_model_.contact.md#static-unscoped)
* [update](_models_contact_model_.contact.md#static-update)
* [upsert](_models_contact_model_.contact.md#static-upsert)

## Constructors

###  constructor

\+ **new Contact**(`values?`: undefined | object, `options?`: BuildOptions): *[Contact](_models_contact_model_.contact.md)*
...
**Returns:** *[Contact](_models_contact_model_.contact.md)*
