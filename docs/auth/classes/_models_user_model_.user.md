[@the-shops/auth](../globals.md) › ["models/user.model"](../modules/_models_user_model_.md) › [User](_models_user_model_.user.md)
...
* [afterBulkDestroy](_models_user_model_.user.md#static-afterbulkdestroy)
